...
CREATE UNIQUE INDEX XPKCapHR_INFO ON HHS_CDC_HR.CAPHR_INFO
(CASE_ID   ASC);

ALTER TABLE HHS_CDC_HR.CAPHR_INFO
...
CREATE UNIQUE INDEX XPKNamed_Acttion ON HHS_CDC_HR.NAMED_ACTION
(CASE_ID   ASC);
