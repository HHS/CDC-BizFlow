    ...
    BEGIN
        ...
        UPDATE HHS_CDC_HR.POSITION
           SET JOB_REQ_NO = V_POS_JOB_REQ_NO
               ...
               ,NUM_OF_DAYS_AD = V_POS_NUM_OF_DAYS_AD 
...
---------- CONSIDERATION AREA
	V_CAREA_SEQ                         INTEGER;
	V_CAREA_CONSIDERATION_PRIMARY       VARCHAR2(400);
    V_CAREA_CONSIDERATION_ADDL          VARCHAR2(400);
---------- DUTY_STATION
	V_DS_SEQ                            INTEGER;
...
BEGIN
   ...
   IF FN_GET_XML_FIELD_VALUE(V_FD_FIELD_DATA, 'SME_NAME_5') IS NOT NULL THEN
    ...
    SELECT FN_GET_XML_FIELD_VALUE(V_FD_FIELD_DATA, 'POS_AOC') 
      ...
      INTO V_CAREA_CONSIDERATION_PRIMARY
           ,V_CAREA_CONSIDERATION_ADDL 
      FROM DUAL;

    IF V_CAREA_CONSIDERATION_PRIMARY IS NOT NULL THEN
        ...
        (
            I_PROCID
            ,1
            ,V_CAREA_CONSIDERATION_PRIMARY
        );
    END IF;

    IF V_CAREA_CONSIDERATION_ADDL IS NOT NULL THEN
